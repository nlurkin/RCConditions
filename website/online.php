...
<style type="text/css"> 
	...
	<div id="Tabs">
		...
		<div id="Content_Area">
			<div id='tab1'> <img border=0 align=center src="Screenshots/NA62BigScreen.png" alt="NA62BigScreen Panel" width="1200" height="600" ></div>
			<div id='tab2' style="display: none;"> <img border=0 align=center src="Screenshots/NA62Environment.png" alt="Environment panel" width="1200" height="600"></div>
			<div id='tab3' style="display: none;"> <img border=0 align=center src="Screenshots/NA62MainDCS.png" alt="Main DCS Panel" width="1200" height="600"></div>
<?php $filename = "Screenshots/NA62BigScreen.png";
